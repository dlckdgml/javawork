...
public class A_Array {
	...
	/*
	 * 변수 : 하나의 공간에 하나의 값을 담을 수 있음 배열 : 하나으 공간에 여려개의 값을 담을 수 있음 "같은 자료형의 값"으로만 담을 수
	...
	public void method1() {
		...
		int[] score = new int[5]; // 배열의 크기를 지정하지않으면 에러!
		...
		/*
		 * -배열을 생성하고 초기화 해주지 않아도 문제없이 출력! -JVM이 저장한 기본값으로 배열이 초기화 (정수형 :0, 실수형 : 0.0,
		 * 문자형 : /u0000, 논리형:false, 참조형 :null)
		 */
	...
	/*
	 * 3며의 키를 입력받아 배열에 저장하고 3명의 키의 평균값을 구하시오.
	 * 키 입력 > 180
	 * 키 입력 > 177.3
	 * 키 입력 > 168.2
	 * 175.2
	...
	public void method5() {
        ...
        System.out.println(number.length); //객체를 식볋할 하나의 정수
	...
	//깊은 복사 : 동인한 새로운 배열을 하나 생성해서 내부으 값들도 함께 복사
	//1) : for문을 이용한 복사
	 ...
	 * [표현법]
	 * 
	 * 2)System.arraycopy(원본 배열, 복사 시작 인덱스, 복사본 배열, 복사 시작 인덱스, 복사할 길이);
	 * 
	 * */		 
	...
	/*
	 * 3)Arrays 클래스의 제공하는
	 *   copyOf() 메소를 이용한 깊은 복사
	 * 
	 * [표현법]
	 * 
	 * 
	 * Arrays.copyOf(원본 배열, 복사복 배열 길이)
	 * */
	...
	public void method8() {
		...
		//System.out.println(copy.length); //NullpointerE
