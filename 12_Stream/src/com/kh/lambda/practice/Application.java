...
public class Application {
	...
	public static void main(String[] args) {
		...
		Mathlnterface plusLambda = (int x, int y) -> { 
			return x + y; 
		};
		Mathlnterface minusLambda = (int x, int y) -> x - y;
		Mathlnterface multipleLambda = (int x, int y) -> x * y;
		Mathlnterface divideLambda = (int x, int y) -> x / y;
