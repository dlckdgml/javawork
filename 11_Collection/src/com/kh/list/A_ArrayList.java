...
//	System.out.println(list.get(0));
	...
	// 7. subList(int index1, int index2) : 추룰해서 새로운 List로 반환
	...
	public void method3() {
		...
		// 13. 내림차순 정렬
		Collections.reverse(list); // 오름차순 정렬 후/		System.out.println(list);
	}
